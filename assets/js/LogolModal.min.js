(function($) {
    $.fn.LogolModal = function(options) {
        var settings = $.extend({
            size: 'medium',
            message: '',
            title: '',
        ...
        $div += '   <div class="kbaru-modal-overlay" id="modalOverlay"> \
                        <div class="kbaru-modal-content"' + (!$hasClassWidth ? ' style="width:' + settings.size + '"' : '') + '>';
                            if(settings.logo || isTitle.length > 0 || settings.buttonClose) {
                                ...
                                if(settings.buttonClose) {
                                    $div += ' <button class="btnLogolModalClose" id="logolModalClose"> \
        ...
        $(document).ready(function() {
            if (settings.buttonClose) {
                $(".btnLogolModalClose").on("click", function() {
                    if ($(".kbaru-modal").length > 0) {
                        $(".kbaru-modal").remove();
                    }
                    return false;
