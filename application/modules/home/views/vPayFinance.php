          ...
          <div class="card-header bg-transparent border-bottom">
            <div class="row" style="font-weight: 700; font-size:14px">
              ...
              <div class="col-md-6 col-sm-6" align="right">
                <p>Rp. <?php echo number_format($this->session->userdata('total'),0,".","."); ?></p>
              </div>
            </div>
          </div>
          <div class="card-header bg-transparent border-bottom">
            <div class="row">
              ...
              <div class="col-md-2 cold-sm-2">
                <a href="#">
                  <span class="text-end" style="margin-right: 0; line-height:50px; font-weight: 700; font-size: 9px;color: #497DF5;">
                    CHANGE
                  </span></a>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                      <p style="font-weight: 500;font-size: 14px;letter-spacing: 0.01em;color: #333333;"> Logol Financing</p>
                    </div>
                    <div class="col-sm-3">
                  ...
                  <div class="row" style="margin-top:25px;">
                    <p style="font-weight: 500; font-size: 10px; letter-spacing: 0.01em; color: #4A4A68;">Payment Details</p>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <p style="font-weight: 500;font-size: 12px;line-height: 16px;letter-spacing: 0.02em;color: #333333;">Interest (1.1%)</p>
                    </div>
                    <div class="col-sm-6">
                      <p class="text-end" style="font-weight: 500;font-size: 12px;line-height: 16px;letter-spacing: 0.02em;color: #333333;">Rp 260.000</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <p style="font-weight: 500;font-size: 12px;line-height: 16px;letter-spacing: 0.02em;color: #333333;">Service Fee</p>
                    </div>
                    <div class="col-sm-6">
                      <p class="text-end" style="font-weight: 500;font-size: 12px;line-height: 16px;letter-spacing: 0.02em;color: #333333;">Free</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <p style="font-weight: 500;font-size: 12px;line-height: 16px;letter-spacing: 0.02em;color: #333333;">Due Date</p>
                    </div>
                    <div class="col-sm-6">
                      <p class="text-end" style="font-weight: 500;font-size: 12px;line-height: 16px;letter-spacing: 0.02em;color: #333333;">05 every month</p>
                    </div>
                  </div>
                  <div class="row" style="margin-top:20px; margin-bottom:20px; padding-top:10px; padding-bottom:10px; padding-left:10px; 
                padding-right: 10px; background-color: #F8F8F9;">
                    <div class="col-sm-6">
                      <p style="font-weight: 500;font-size: 12px;line-height: 16px;letter-spacing: 0.02em;color: #333333;">Monthly Paid </p>
                    </div>
                    <div class="col-sm-6">
                      <p class="text-end" style="font-weight: 500;font-size: 12px;line-height: 16px;letter-spacing: 0.02em;color: #333333; font-weight:700; color:#044795">Rp 240.000
                    </div>
                  </div>
                  <div class="row" style="padding-left:15px;">
                    <p style="font-weight: 500; font-size: 10px; letter-spacing: 0.01em; color: #4A4A68;">Info</p>
                    <ul style="font-weight: 500; font-size: 12px; line-height: 16px; letter-spacing: 0.02em; color: #333333;">
            ...
            <div class="col-md-5 mt-3">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-3">
                      <img src="<?php echo base_url('assets/images/ovo.png'); ?>">
                    </div>
                    <div class=" col-sm-5">
                      <p style="font-weight: 500;font-size: 14px;letter-spacing: 0.01em;color: #333333;"> OVO Paylater</p>
                    </div>
                    <div class="col-sm-3">
                    </div>
                  </div>
