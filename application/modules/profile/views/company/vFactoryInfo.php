...
<form class="" action="<?= (!empty($collections) ? $collections['action'] : site_url('profile/setCallBackFactoryStore')); ?>" autocomplete="off" method="post" id="v4-factory-info" name="v4-factory-info">
    <?= (!empty($collections) ? '<input type="hidden" name="factoryId" value="' . $collections['attribute']['factoryId']. '" wajib="yes" readonly>' : ''); ?>
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-6">
            <div class="form-floating">
                <input type="text" class="form-control input-v4 input-v4-mb-8 input-v4-pl-12 w-100 input-v4-required" id="factoryName" placeholder="Factory Name" wajib="yes" name="factoryName" <?= (!empty($collections) ? 'value="' . $collections['attribute']['factoryName'] . '"' : ''); ?>>
                <label for="factoryName">Factory Name</label>
            </div>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-6">
            <div class="form-floating">
                <input type="text" class="form-control input-v4 input-v4-mb-8 input-v4-pl-12 w-100 input-v4-required" id="factoryPicName" placeholder="PIC Name" wajib="yes" name="factoryPicName" <?= (!empty($collections) ? 'value="' . $collections['attribute']['factoryPicName'] . '"' : ''); ?>>
                <label for="factoryPicName">PIC Name</label>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-6">
            <div class="form-floating">
                <input type="text" class="form-control input-v4 input-v4-mb-8 input-v4-pl-12 w-100 input-v4-required" id="factoryOfficePhone" placeholder="Office Phone" wajib="yes" name="factoryOfficePhone" <?= (!empty($collections) ? 'value="' . $collections['attribute']['factoryOfficePhone'] . '"' : ''); ?>>
                <label for="factoryOfficePhone">Office Phone</label>
            </div>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-6">
            <div class="form-floating">
                <input type="text" class="form-control input-v4 input-v4-mb-8 input-v4-pl-12 w-100 input-v4-required" id="factoryMobilePhone" placeholder="Mobile Phone" wajib="yes" name="factoryMobilePhone">
                <label for="factoryMobilePhone">Mobile Phone</label>
            </div>
        </div>
    </div>
    <div class="pin-address">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 t24-l24">
                <input type="text" name="factoryAddressPin" id="v4-factory-address" class="form-control input-v4 input-v4-pl-40 w-100" placeholder="Write street Name/Building Name/Housing Area" <?= (!empty($collections) ? 'value="' . $collections['attribute']['factoryAddress'] . '"' : ''); ?>>
                <div class="icon">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div id="v4-factory-pin" style="margin: 0 auto; width: 100%; height: 243px;"></div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 t24-l24">
                <input type="text" name="factoryAddressLatLong" id="v4-factory-address-latlang" class="form-control input-v4 input-v4-pl-40 w-100" placeholder="-">
                <div class="icon">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="form">
                    ...
                    <?= form_dropdown('provinceId', $provinceId, (!empty($collections) ? $collections['attribute']['factoryProvinceId'] : ''), 'class="form-control input-v4-mb-8 input-v4-pl-12 w-100 bes-select" id="provinceId" data-url="' . site_url('autocomplete/getCityByProvince'). '" data-target="cityId"'); ?>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="form">
                    <label for="">City</label>
                    <?= form_dropdown('cityId', $cityId, (!empty($collections) ? $collections['attribute']['factoryCityId'] : ''), 'class="form-control input-v4-mb-8 input-v4-pl-12 w-100 bes-select" id="cityId" data-url="' . site_url('autocomplete/getDistrictByCity'). '" data-target="districtId"'); ?>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="form">
                    ...
                    <?= form_dropdown('districtId', $districtId, (!empty($collections) ? $collections['attribute']['factoryDistrictId'] : ''), 'class="form-control input-v4-mb-8 input-v4-pl-12 w-100 bes-select" id="districtId" data-url="' . site_url('autocomplete/getAreaIdByDistrict'). '" data-target="areaId"'); ?>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="form">
                    <label for="">Area</label>
                    <?= form_dropdown('areaId', $areaId, (!empty($collections) ? $collections['attribute']['factoryAreaId'] : ''), 'class="form-control input-v4-mb-8 input-v4-pl-12 w-100 bes-select" id="areaId"'); ?>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="form-floating">
                    <textarea class="form-control input-v4 input-v4-mb-8 input-v4-pl-12 w-100" id="factoryAddress" placeholder="Address" name="factoryAddress" style="height: 80px; resize: none;"><?= (!empty($collections) ? $collections['attribute']['factoryAddress']: ''); ?></textarea>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="wrapper-buttons-dialog wrapper-w-loader" id="<?= rand(); ?>">
                ...
                <button class="btn-container-dialog btn-dialog-submit" id="<?= rand(); ?>" onclick="v4DoPost('v4-factory-info', $(this), 'v4-list-factory-active'); return false;"><?= (!empty($collections) ? 'Update' : 'Save'); ?></button>
            </div>
        </div>
    </div>
</form>
<script>
    function autocompleteWithEnter(map) {
        const searchInput = document.getElementById("v4-factory-address");
        const options = {};
        ...
        google.maps.event.addListener(autocomplete, "place_changed", function () {
            ...
            if (typeof place.address_components !== "undefined") {
                ...
                $("#v4-factory-address-latlang").val(userLocation.lat + ', ' + userLocation.lng);
            }
        ...
        function geocodePosition(pos) {
            ...
            geocoder.geocode({latLng: pos}, function(results, status){
                if (status == google.maps.GeocoderStatus.OK) {
                    $("#v4-factory-address").val(results[0].formatted_address);
                    $("#v4-factory-address-latlang").val(results[0].geometry.location.lat() + ', ' + results[0].geometry.location.lng());
                }  else  {
                    console.log(status);
                }
            });
    ...
    function initialize() {
        ...
        const map = new google.maps.Map(
            document.getElementById("v4-factory-pin"),
            mapOptions
        );
