...
<form class="" action="<?= (!empty($collections) ? $collections['action'] : site_url('profile/setCallBackAddressStore')); ?>" autocomplete="off" method="post" id="v4-address-info-edit" name="v4-address-info-edit">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="form">
                    ...
                    <?= form_dropdown('cityId', '', (!empty($collections) ? $collections['attribute']['cityId'] : ''), 'class="form-control input-v4-mb-8 input-v4-pl-12 w-100 bes-select" id="cityId" data-url="' . site_url('autocomplete/getDistrictByCity'). '" data-target="districtId"'); ?>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="form">
                    ...
                    <?= form_dropdown('districtId', '', (!empty($collections) ? $collections['attribute']['districtId'] : ''), 'class="form-control input-v4-mb-8 input-v4-pl-12 w-100 bes-select" id="districtId" data-url="' . site_url('autocomplete/getAreaIdByDistrict'). '" data-target="areaId"'); ?>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="form">
                    <label for="">Area</label>
                    <?= form_dropdown('areaId', '', (!empty($collections) ? $collections['attribute']['areaId'] : ''), 'class="form-control input-v4-mb-8 input-v4-pl-12 w-100 bes-select" id="areaId"'); ?>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="wrapper-buttons-dialog wrapper-w-loader" id="<?= rand(); ?>">
                ...
                <button class="btn-container-dialog btn-dialog-submit" id="<?= rand(); ?>" onclick="v4DoPost('v4-address-info-edit', $(this), 'v4-list-user-active'); return false;"><?= (!empty($collections) ? 'Update' : 'Save'); ?></button>
            </div>
        </div>
    </div>
</form>
