        ...
        <table id="tableEtruck" class="table align-middle dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">eport1.pdf</a> </td>
                    <td>
                ...
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">eport2.pdf</a> </td>
                    <td>
                        <button type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</button>
                </tr>
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">eport3.pdf</a> </td>
                    <td>
                        <button type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</button>
                </tr>
                <tr>
