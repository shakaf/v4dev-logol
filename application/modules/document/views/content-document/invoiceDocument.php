...
<div class="row" style="background-color: white; padding: 15px;">
    ...
    <div class="col-md-4">
        <input class="form-control" type="text" placeholder="Document Name" id="myInputTextField">
    </div>
...
<div class="row" style="margin-top:10px;background-color:white;color:#868A92;">
    <div class="table-responsive">
        ...
        <table id="datatable-invoice" class="table align-middle dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
            ...
            <thead>
                <tr class="bg-transparent">
                    ...
                    <th style="width: 70%;">Invoice ID</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">Inv_2345443233.pdf</a> </td>
                    <td>
                        <a href="<?php echo base_url('detail-document') ?>" type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</a>
                </tr>
                <tr>
                    <td style="width:5%;">
                        <div class="form-check font-size-16">
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">Inv_5262427373.pdf</a> </td>
                    <td>
                        <a href="<?php echo base_url('detail-document') ?>" type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</a>
                </tr>
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">Inv_46572624724.pdf</a> </td>
                    <td>
                        <a href="<?php echo base_url('detail-document') ?>" type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</a>
                </tr>
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">Inv_1235443233.pdf</a> </td>
                    <td>
                        <a href="<?php echo base_url('detail-document') ?>" type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</a>
                </tr>
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">Inv_23443543233.pdf</a> </td>
                    <td>
                        <a href="<?php echo base_url('detail-document') ?>" type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</a>
                </tr>
    ...
    <script>
        ...
        $('#datatable-invoice').on('search.dt', function() {
            var value = $('#myInputTextField').val();
