...
<div class="row" style="margin-top:10px;background-color:white;color:#868A92;">
    <div class="table-responsive">
        <table id="tableALLDoc" class="table align-middle dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;"">
            <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">EdepotDoc2.pdf</a> </td>
                    <td>
                        <button type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</button>
                </tr>
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">EdepotDoc3.pdf</a> </td>
                    <td>
                        <button type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</button>
                </tr>
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">eport4.pdf</a> </td>
                    <td>
                        <button type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</button>
                </tr>
                <tr>
                    ...
                    <td style="width: 70%;"><a href="javascript: void(0);" class="text-dark fw-medium">eport5.pdf</a> </td>
                    <td>
                        <button type="button" class="btn btn-outline-primary waves-effect waves-light" style=" border: 1px solid #405EA3;">View</button>
                </tr>
                <tr>
