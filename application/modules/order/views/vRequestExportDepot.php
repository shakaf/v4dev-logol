...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-10">
			<div id="exportdepot-wizard" class="twitter-bs-wizard">
				...
				<div class="tab-content twitter-bs-wizard-tab-content">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="mt-3 mt-lg-0">
											<div>
												<select class="form-select w-50 select2" name="depotId" id="depotId" onchange="selectDepo(this.value); return false;">
										...
										<form id="formA" method="post" action="">
												...
												<div class="col-lg-4">
													<div class="mt-3 mt-lg-0">
														<div class="mb-3 ">
															...
															<input class="form-control dointrefnumber" type="text" placeholder="Input Here">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="col-lg-4">
													<div class="mt-3 mt-lg-0">
														<div class="mb-3">
															...
															<input class="form-control donumber" type="text" placeholder="Input Here" required>
														</div>
													</div>
												</div>
												<div class="col-lg-4">
													<div class="mt-3 mt-lg-0">
														<div class="mb-3">
															...
															<input class="form-control dodate" name="dodate" type="date" placeholder="Input Here" required>
														</div>
													</div>
												</div>
												<div class="col-lg-4">
													<div class="mt-3 mt-lg-0">
														<div class="mb-3">
															...
															<div class="input-group" onclick="javascript:document.getElementById('file').click();">
																<input class="form-control" name="upload" style="background-color:white;" id="uploadAttachment" type="text" placeholder="Upload Document" readonly required>
												...
												<div class="col-lg-4">
													<div class="mt-3 mt-lg-0">
														<div class="mb-3">
															...
															<select name="grade" id="grade" class="form-select grade" required>
											...
											<div class="row mx-2">
												...
												<div class="col-sm-2" style="float:right">
													<button type="button" style="width:10em" href="javascript: void(0);" class="btn btn-primary waves-effect waves-light mb-sm-3" onclick="toggle(event)">
					...
					<div class="tab-pane" id="steps-2">
						<div class="d-flex flex-wrap">
							...
							<span style="cursor:pointer" onclick="backtoZero()">
						...
						<div class="row mt-3">
							<div class="col-md-8">
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-md-5 col-sm-5" style="text-align: end;">
												...
												<!-- data-bs-toggle="modal" data-bs-target=".bs-example-modal-center-booking" -->
												<button type="button" class="btn btn-primary" onclick="checkItem();" style="font-size: 12px; border-radius:10px; background:#497DF5;">Booking Now</button>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-3 col-sm-3">
												...
												<p class="t-desc" style="color: #044795;">DOAttachment.pdf</p>
											</div>
											<div class="col-md-3 col-sm-3">
								...
								<div class="nav-title mt-5">
									...
									<p class="description" style="font-size:12px;">Please select which order you will process into the next step (payment)</p>
								</div>
								<!-- ==========select all ========= -->
								<div class="row">
										...
										<div class="card">
											...
											<div class="card-body p-4">
												<div class="row">
													...
													<div class="col-md-3 col-sm-3">
														<label class="description" style="color: #4A4A68;">Depot</label>
														<p class="t-desc gi-depo">BSA</p>
													</div>
													<div class="col-md-3 col-sm-3">
														<label class="description" style="color: #4A4A68;">Shipping Line</label>
														<p class="t-desc gi-shippingline">Maersk Line</p>
													</div>
													<div class="col-md-3 col-sm-3">
														<label class="description" style="color: #4A4A68;">Bussiness Unit</label>
														<p class="t-desc">-</p>
													</div>
													<div class="col-md-3 col-sm-3">
														<label class="description" style="color: #4A4A68;">Container Grade</label>
														<p class="t-desc gi-grade">GRADE B</p>
													</div>
												</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body" align="center">
					...
					<div style="text-align: end;">
						<!-- href="<?php echo base_url('detil-payment') ?>" -->
						<a href="javascript:;" onclick="bookingNow();" style="width:25%;" type="button" class="btn btn-primary waves-effect waves-light">Confirm</a>
					</div>
				</div>
			</div><!-- /.modal-content -->
		</div><!-- /.modal-dialog -->
