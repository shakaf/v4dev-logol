						...
						<div class="row mt-3">
							<div class="col-md-8">
								...
								<div class="nav-title mt-5">
									...
									<p class="description">Please, review your order before you will process into the next step (booking now)</p>
								</div>

								<!-- <div class="row">
									<div class="col-md-12 col-sm-12">
										<input type="checkbox" id="checkallList" class="" style="width: 20px; height: 20px;">
								...
								<div class="row mt-3">
									...
									<!-- <div class="col-md-1 col-sm-1">
										<input type="checkbox" id="checkall2" class="checkitemlist" style="width: 20px; height: 20px;">
									</div> -->
									<div class="col-md-12 col-sm-12">
										<div class="card">
